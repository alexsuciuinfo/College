       ...
       try{
        int rez,id;
         ...
         String contact[] = {request.getParameter("nume"), request.getParameter("prenume"),request.getParameter("telefon_m"),
            ...
            out.println("<input type = \"submit\" value = \"Edit\" class = \"sub\">");
        ...
        try{
            ...
            if(!Nou(contact))
                ...
                if(success(contact))
            {
                rez = sql.update(id,contact);
                if(rez > 0) out.println("<p style=\"color:green ; font-size:20px\"> Contactul a fost updatat </p>");
            }
              ...
              out.println("<p style=\"color:red ; font-size:20px\"> Format invalid ID ! </p>");
          }
...
"  </tr>");
    ...
    public String ok(){
         ...
         String rez = "<p style=\"color:green ; font-size:20px\"> Contact updatat cu succes ! </p>";
         return rez;
    }
